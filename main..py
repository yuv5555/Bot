...
BOT_TOKEN = os.environ.get("7775636547:AAFiBaS7tEuIcIlT0OSALgtfSAPOSjQDANU")
...
async def get_music(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        ydl_opts = {
            ...
            'quiet': True,
            'noplaylist': True,
            'cookies': '/path/to/your/cookies.txt',  # Add your cookies path here
        }
...
def main():
    ...
    app = ApplicationBuilder().token("7775636547:AAFiBaS7tEuIcIlT0OSALgtfSAPOSjQDANU").build()
